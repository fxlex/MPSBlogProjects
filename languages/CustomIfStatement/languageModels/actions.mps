...
<model ref="r:5cf8b8cf-4060-4c7e-8a4c-21a73b002bd1(CustomIfStatement.actions)">
  ...
  <node concept="3FK_9_" id="6MpY$JtoX6">
    <property role="TrG5h" value="AddMyIfStatement" />
    <node concept="3FOIzC" id="6MpY$JtoZl" role="3FOPby">
      <ref role="3FOWKa" to="tpee:fzclF8l" resolve="Statement" />
      <node concept="35xCft" id="6MpY$JtoZn" role="tZc4B">
        <ref role="35y72J" to="a61i:6MpY$JrMUj" resolve="MyIfStatement" />
      </node>
    </node>
  </node>
</model>
